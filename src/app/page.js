...
export default function IWICalculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-emerald-50 p-4 sm:p-8 font-sans">
        ...
        {walls.map((wall, index) => {
          ...
          return (
            ...
            >
              ...
              >
                {`${wall.elevation} ${wall.floor} IWI Area = (${wall.length}×${wall.height}) − (${wall.subtract}) = ${calculateArea(wall).toFixed(2)} m²`}
              </span>
      ...
      <div
        ref={reportRef}
        className="mt-10 bg-white p-6 rounded shadow overflow-x-auto"
      >
