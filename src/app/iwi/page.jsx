  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-gray to-amber-100 p-4 sm:p-8 pt-20 sm:pt-28 font-sans">
      ...
      >
        ...
        <p className="mt-3 font-semibold text-orange-500">Solid Wall={totals.totalWallArea > 0 ? Math.ceil(((totals.totalWallArea - totals.cavityArea) / totals.totalWallArea) * 100): 0}%</p>
        {totals.cavityArea > 0 && (
        <p className="mt-3 font-semibold text-orange-500">Cavity Wall={Math.ceil((totals.cavityArea / totals.totalWallArea) * 100)}%</p>
        )}
